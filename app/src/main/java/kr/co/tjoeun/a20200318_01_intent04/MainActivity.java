...
//        requestCode => 어떤화면으로 띄운화면인지? 구별.
//        이름변경 or 프사 변경 개발자가 분류한 requestCode값을 따라감.

        if(requestCode == 1000) {
//            우리가 요청한 프로필 변경 화면 이동이다!

//            resultCode => 완료 /취소 여부. 보통 완료 일때만 대응.
            if (resultCode == RESULT_OK) {
//                확인 버튼을 눌러서 finish가 되었다!
